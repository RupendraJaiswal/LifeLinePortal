...
<body>
	<m:catch var="exp">
		<m:set var="strsql" value="select * from donor"></m:set>
			...
			<tbody>
				<m:forEach var="rowdata" items="${records.rows}">
					<tr>
						...
						<th scope="row"><m:out value="${rowdata.phone}"></m:out></th>
						<th scope="row"><m:out value="${rowdata.bloodgroup}"></m:out></th>
						<th scope="row"><m:out value="${rowdata.city}"></m:out></th>
					</tr>
				</m:forEach>
			</tbody>
		</table>
